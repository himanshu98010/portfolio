  ...
  const education = [
    {
      ...
      year: "2023 - 2027",
      description:
        " ~ Currently Pursuing. Focused on software engineering, data structures, and web development.",
      gpa: "8/10",
    },
    {
      ...
      year: "2021 - 2023",
      description:
        "Mathematics, Physics, Chemistry. Strong foundation in Computer Science.",
      gpa: "A",
    },
    {
      degree: "Self Learnings",
      description:
        "A self learner passionate to dive deep in the world of tech . Exploring new technologies and Working on projects daily",
      year: "2023 - present",
    },
  ];
                ...
                <div className="ml-20">
                  <Card className="hover:shadow-lg transition-all duration-300 hover:scale-[1.02] bg-card/50 backdrop-blur-sm border-border/50">
                    <CardContent className="p-6">
                      ...
                      <p className="text-lg font-medium text-gray-600 dark:text-muted-foreground mb-2">
                        {edu.institution}
                      </p>
